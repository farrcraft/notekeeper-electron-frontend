...
goog.exportSymbol('proto.notekeeper.SaveUIStateResponse', null, global);
 ...
 * @constructor
 */
proto.notekeeper.SaveUIStateResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.notekeeper.SaveUIStateResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.notekeeper.SaveUIStateResponse.displayName = 'proto.notekeeper.SaveUIStateResponse';
}
 ...
 * @return {!Object}
 */
proto.notekeeper.SaveUIStateResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.notekeeper.SaveUIStateResponse.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.notekeeper.SaveUIStateResponse} msg The msg instance to transform.
 * @return {!Object}
 */
proto.notekeeper.SaveUIStateResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.notekeeper.SaveUIStateResponse}
 */
proto.notekeeper.SaveUIStateResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.notekeeper.SaveUIStateResponse;
  return proto.notekeeper.SaveUIStateResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.notekeeper.SaveUIStateResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.notekeeper.SaveUIStateResponse}
 */
proto.notekeeper.SaveUIStateResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * Class method variant: serializes the given message to binary data
 * (in protobuf wire format), writing to the given BinaryWriter.
 * @param {!proto.notekeeper.SaveUIStateResponse} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.notekeeper.SaveUIStateResponse.serializeBinaryToWriter = function(message, writer) {
  message.serializeBinaryToWriter(writer);
};
 ...
 * @return {!Uint8Array}
 */
proto.notekeeper.SaveUIStateResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  this.serializeBinaryToWriter(writer);
  return writer.getResultBuffer();
};
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.notekeeper.SaveUIStateResponse.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getStatus();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.notekeeper.SaveUIStateResponse.prototype.getStatus = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.notekeeper.SaveUIStateResponse.prototype.setStatus = function(value) {
  jspb.Message.setField(this, 1, value);
};
